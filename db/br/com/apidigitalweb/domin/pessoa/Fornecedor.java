...
import br.com.apidigitalweb.converters.TipoFornecedorConverter;
...
@Entity
@NoArgsConstructor
public class Fornecedor extends BasePessoaJuridica implements Serializable, BaseEntity, BaseEntityPessoa {
	...
	public Fornecedor(BasePessoaJuridicaDTO p, Endereco e) {
		...
		this.emailcontato = p.getEmailcontato();
		this.telefonecontato = p.getTelefonecontato();
		this.setorcontato = p.getSetorcontato();
	...
	@Override
	public Fornecedor loadCnpjThis(BasePessoaJuridicaDTO p, Endereco e) {
