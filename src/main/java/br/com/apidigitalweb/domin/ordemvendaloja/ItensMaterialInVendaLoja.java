...
@Entity
@NoArgsConstructor
public class ItensMaterialInVendaLoja   extends BaseDomain  implements BaseEntity, Serializable {
	...
	public ItensMaterialInVendaLoja(AnuncioLoja a) {
		super();
		this.produto = a ;
		this.quantidade = 0;
