...
@Entity
@NoArgsConstructor
public class ItensMaterialInVendaWeb   extends BaseDomain  implements BaseEntity, Serializable {
	...
	public ItensMaterialInVendaWeb(AnuncioLoja a) {
		super();
		this.produto = a ;
		this.quantidade = 0;
